        ...
        <div className="auth-hero">
          <div>
            ...
            <p className="auth-copy">
              A premium messenger rebuilt around the existing backend contract:
              register, login, discover users, and start live chats with a polished
              glass interface.
            </p>
          </div>
